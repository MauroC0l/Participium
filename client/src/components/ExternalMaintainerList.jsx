    ...
    <div className="externalMaintainerList-modern">
      ...
      <div className="eml-card">
        <div className="eml-card-body">
          {loading ? (
            <div className="eml-loading"><div className="eml-loading-spinner"></div>Loading...</div>
          ) : filteredUsers.length === 0 ? (
            <div className="eml-empty"><div>👷</div>No maintainers found.</div>
          ) : (
       ...
       <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)} centered>
         ...
         <Modal.Footer>
            <button className="eml-modal-btn eml-modal-btn-danger" onClick={handleDeleteConfirm}>Delete</button>
         </Modal.Footer>
       </Modal>
    </div>
  );
